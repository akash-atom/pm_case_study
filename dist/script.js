...
plyrStyle.textContent = "--plyr-color-main: #f33f32;.plyr--full-ui input[type=range]{color:#f33f32}.plyr__control--overlaid{background:#f33f32}.plyr__control--overlaid:hover{background:#d63529}.plyr__menu__container [role=menuitemradio][aria-checked=true]::before{background:#f33f32}[id^='vertical_video-'] .plyr__control--overlaid{display:none!important}[id^='vertical_video-'] .plyr__controls{display:none!important}";
document.head.appendChild(plyrStyle);
document.addEventListener("DOMContentLoaded", function() {
    console.log("DOMContentLoaded");
    const OFFSET = 98; // navbar height + 16px breathing room
    const ACTIVE_COLOR = "#8D4CDD";
    ...
    tocLinks.forEach(function(link) {
        link.addEventListener("click", function(e) {
            ...
            if (window.innerWidth < 991) {
                ...
                if (mToc && mToc.offsetHeight > 60) mToc.click();
            }
    ...
    document.addEventListener("click", function(e) {
        ...
        if (mToc.offsetHeight > 60) mToc.click();
    });
    var lastActive = null;
    ...
    var verticalVideos = [
        {
            containerId: "vertical_video-1",
            vimeoId: "1179493915"
        },
        {
            containerId: "vertical_video-2",
            vimeoId: "1179494833"
        },
        {
            containerId: "vertical_video-3",
            vimeoId: "1179489548"
        }
    ];
