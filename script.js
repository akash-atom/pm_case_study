...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const OFFSET = 82 + 16; // navbar height + 16px breathing room
  ...
  heroTl.to([".aw_logo_top", ".cross_icon", ".pm_logo_top"], {
    opacity: 1,
    y: 0,
    duration: 1.2,
    ease: "power2.out",
  ...
  var numberTargets = [
    { value: 7.5, suffix: "hrs", decimals: 1 },
    { value: 2, suffix: "hrs", decimals: 0 },
    { value: 2, suffix: "hrs", decimals: 0 },
    { value: 40, suffix: "mins", decimals: 0 }
  ];
